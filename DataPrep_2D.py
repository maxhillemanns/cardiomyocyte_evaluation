# -*- coding: utf-8 -*-
"""
Created on Thu Feb 27 12:29:37 2020
...
def data_prep_2D(table_location, image_location, task_flag, shape):

    if task_flag == 0:

        max_dim_sarc = np.zeros((1,2))
        ...
        for i in range(adult_s_truth.shape[0]):
            ...
            temp_im = io.imread(image_location+"adult/MAX_"+temp_name+".tif")
        ...
        for i in range(cor4u_s_truth.shape[0]):
            ...
            temp_im = io.imread(image_location+"cor4u/MAX_"+temp_name+".tif")
            temp_im = resize(temp_im, shape)
        ...
        for i in range(ipsc_s_truth.shape[0]):
            ...
            temp_im = io.imread(image_location+"IPSCs/MAX_"+temp_name+".tif")
            temp_im = resize(temp_im, shape)
        ...
        for i in range(neonatal_s_truth.shape[0]):
            ...
            temp_im = io.imread(image_location+"neonatal/MAX_"+temp_name+".tif")
            temp_im = resize(temp_im, shape)
        ...
        for i in range(w4esc_s_truth.shape[0]):
            ...
            temp_im = io.imread(image_location+"w4ESC/MAX_"+temp_name+".tif")
            temp_im = resize(temp_im, shape)
    ...
    if task_flag == 2:
        ...
        max_dim = np.zeros((1,2))

        adult_list = []
        
        for i in os.listdir(image_location+"adult"):
            if os.path.isfile(os.path.join(image_location+"adult",i)) and i.startswith("MAX_"):
                adult_list.append(i)
        ...
        for i in os.listdir(image_location+"cor4u"):
            if os.path.isfile(os.path.join(image_location+"cor4u",i)) and i.startswith("MAX_"):
                cor4u_list.append(i)
        ...
        for i in os.listdir(image_location+"IPSCs"):
            if os.path.isfile(os.path.join(image_location+"IPSCs",i)) and i.startswith("MAX_"):
                ipsc_list.append(i)
        ...
        for i in os.listdir(image_location+"neonatal"):
            if os.path.isfile(os.path.join(image_location+"neonatal",i)) and i.startswith("MAX_"):
        ...
        for i in os.listdir(image_location+"w4ESC"):
            if os.path.isfile(os.path.join(image_location+"w4ESC",i)) and i.startswith("MAX_"):
                w4esc_list.append(i)
...
def split_2D(images , labels, ratio):

    images_train = np.zeros((1, images.shape[1], images.shape[2], images.shape[3]))
    ...
    for i in range(labels.shape[1]-1):
            ...
            temp_images = temp_images.reshape(temp_images.shape[0], temp_images.shape[2], temp_images.shape[3], temp_images.shape[4])
...
def data_augmentation_2D(images, labels, degree, in_shape, rotation=True, mirror=True):
        ...
        if i > 0:
            ...
            for j in range(current_img.shape[0]):
                ...
                for k in range(lengths[3,i-1]):
                    ...
                    temp = temp.reshape(1, in_shape[0], in_shape[1], in_shape[2])
