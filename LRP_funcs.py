# -*- coding: utf-8 -*-
"""
Created on Sat Apr 18 10:06:04 2020
...
from keras.layers import MaxPooling2D, Conv2D, BatchNormalization, LeakyReLU
...
class LRP:
    ...
    def explain(self, image, target_class):
        ...
        while len(previous) > 0:
            ...
            elif isinstance(curr_layer, BatchNormalization):
                new_r = self.lrp_layer_skip(r)
            elif isinstance(curr_layer, LeakyReLU):
                new_r = self.lrp_layer_skip(r)
            else:
